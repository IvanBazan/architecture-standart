...
| F_site_1 | новый клиент должен видеть список доступных депозитов с актуальными ставками                                       |             |
| F_site_2 | новый клиент может создавать заявки на депозит через сайт (ФИО + телефон)                              |             |
